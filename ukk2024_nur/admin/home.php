  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse mt-2" id="navbarNavAltMarkup">
      <div class="navbar-nav me-auto">
        <a href="home.php" class="nav-link"><i class="bi bi-house-heart-fill"></i></i></a>
...
<div class="card-footer text-center">
    ...
    <?php
    $jmlkomen = mysqli_query($conn, "SELECT * FROM komentar WHERE fotoid='$fotoid'");
                ...
                <div class="col-md-4">
                  <div class="m-2">
                    <div class="overflow-auto">
                      ...
                      <?php 
                      $fotoid= $data['fotoid'];
                      $komentar=mysqli_query($conn, "SELECT * FROM komentar INNER JOIN user ON komentar.userid=user.userid WHERE komentar.fotoid='$fotoid'");
...
<footer class="d-flex justyfy-content-center border-top mt-3 bg-light fixed-bottom">
    <p>&copy; UKK RPL 2024 | Nazwa Nurazizah</p>
</footer>
