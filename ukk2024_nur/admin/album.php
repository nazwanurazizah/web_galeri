...
<body>
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse mt-2" id="navbarNavAltMarkup">
      ...
      <a href="../config/aksi_logout.php" class="btn btn-outline-primary m-1"><i class="bi bi-box-arrow-right"></i></a>
    </div>
  </div>
</nav>
      ...
      <div class="modal-body">
        <form action="../config/aksi_album.php" method="POST">
            ...
            <label class="form-label">Nama Album</label>
                    ...
                    <label class="form-label" <?php echo $data['deskirpsi'] ?>>Deskripsi</label>
